...
class PerceptronModified
{
	...
	public static void percept(double[] x, double[] y, double[] z, double[] outputs){ 
	...
	public static void main(String args[]){ 
		...
		double[] x= {randomNumber(5 , 10),randomNumber(5 , 10),randomNumber(-1 , 3),randomNumber(-1 , 3)};
		double[] y= {randomNumber(4 , 8),randomNumber(4 , 8),randomNumber(-4 , 2),randomNumber(-4 , 2)};
		double[] z= {randomNumber(2 , 9),randomNumber(2 , 9),randomNumber(-3 , 5),randomNumber(-3 , 5)};
		double[] outputs = {1,1,0,0};
		
		
		percept(x,y,z,outputs);
	}
